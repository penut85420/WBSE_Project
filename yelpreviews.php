...
$CLIENT_ID = "AF7Kb9--oi9kHXEMnPqn4A";
$CLIENT_SECRET = "slxJXRdtvgnFny3oLhTOyM7gm3gzo5tJskaG2ACwtkiDRua1mFHBZk7BOG7GeGbX";
...
function request($bearer_token, $host, $path, $url_params = array()) {
    ...
    try {
        ...
        $url = $host . $path . "marlowe-san-francisco-2/reviews";
        curl_setopt_array($curl, array(
            CURLOPT_URL => $url,
            CURLOPT_RETURNTRANSFER => true,  // Capture response.
            CURLOPT_ENCODING => "",  // Accept gzip/deflate/whatever.
